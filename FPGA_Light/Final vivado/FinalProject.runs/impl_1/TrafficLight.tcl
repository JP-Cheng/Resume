...
set rc [catch {
  ...
  open_checkpoint TrafficLight_routed.dcp
  set_property webtalk.parent_dir {C:/Peter/Class/Second Year/Switching Circuit and Logic Design/LAB/LAB13_Final/Final vivado/FinalProject.cache/wt} [current_project]
