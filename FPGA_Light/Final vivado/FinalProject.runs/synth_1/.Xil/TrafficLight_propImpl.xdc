set_property SRC_FILE_INFO {cfile:{C:/Peter/Class/Second Year/Switching Circuit and Logic Design/LAB/LAB13_Final/Final vivado/src/don't touch/PortDefine_basys3.xdc} rfile:{../../../src/don't touch/PortDefine_basys3.xdc} id:1} [current_design]
