...
HD_PWD='C:/Peter/Class/Second Year/Switching Circuit and Logic Design/LAB/LAB14_FinalExt/Final vivado/FinalProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TrafficLight.vdi -applog -m64 -messageDb vivado.pb -mode batch -source TrafficLight.tcl -notrace
