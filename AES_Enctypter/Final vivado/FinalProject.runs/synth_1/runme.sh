...
HD_PWD='C:/Peter/Class/Second Year/Switching Circuit and Logic Design/LAB/LAB14_FinalExt/Final vivado/FinalProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TrafficLight.vds -m64 -mode batch -messageDb vivado.pb -notrace -source TrafficLight.tcl
